		...
		if(browserName.equals("chrome")) {
		 ...
		 driver=new ChromeDriver();
			...
			System.setProperty("webdriver.gecko.driver",
					"C://Users//emrba//OneDrive//Masa�st�//Drivers//WebDrivers//geckodriver-v0.26.0-win64/geckodriver.exe");
			 driver=new FirefoxDriver();
		}			
		else if(browserName.equals("ie")) {
			System.setProperty("webdriver.ie.driver",   //fix ie , something wrong
					"C://Users//emrba//OneDrive//Masa�st�//Drivers//WebDrivers//IEDriverServer_x64_3.150.1/IEDriverServer.exe");
